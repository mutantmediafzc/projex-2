      ...
      <div className="relative z-10 w-full sm:max-w-xl max-h-[95vh] sm:max-h-[85vh] overflow-hidden rounded-t-2xl sm:rounded-2xl border-0 sm:border border-slate-200/50 bg-white shadow-2xl safe-area-inset-bottom">
        <div className="flex items-start justify-between gap-4 border-b border-slate-200 bg-white px-6 py-5">
          <div className="min-w-0">
            ...
            {task.updated_by_name && (
              <p className="mt-1 text-xs text-slate-400">
                Updated by {task.updated_by_name}
              </p>
            )}
          </div>
          <div className="flex shrink-0 items-center gap-2">
            ...
            <button
              type="button"
              onClick={onClose}
              className="rounded-lg bg-slate-100 px-3 py-2 text-sm text-slate-500 hover:bg-slate-200"
            >
              Close
            </button>
          </div>
        ...
        <div className="max-h-[60vh] overflow-y-auto px-6 py-5">
          {isEditMode ? (
            <>
              {/* Edit Mode */}
              <div className="mb-4 space-y-3 rounded-xl bg-slate-50 p-4 [&_input]:mt-1 [&_input]:rounded-lg [&_input]:border-slate-300 [&_input]:p-2 [&_input]:text-sm [&_label]:mb-0 [&_label]:text-xs [&_label]:font-semibold [&_label]:normal-case [&_label]:tracking-normal [&_label]:text-slate-900 [&_select]:mt-1 [&_select]:rounded-lg [&_select]:border-slate-300 [&_select]:p-2 [&_select]:text-sm [&_textarea]:mt-1 [&_textarea]:rounded-lg [&_textarea]:border-slate-300 [&_textarea]:p-2 [&_textarea]:text-sm">
                <div>
                ...
                <div className="space-y-2 pt-1">
                  <button
                    ...
                    className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-violet-600 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-violet-700 disabled:opacity-50"
                  >
                    {saving ? (
                      <>
                  ...
                  <button
                    ...
                    disabled={saving}
                    className="w-full rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-100 disabled:opacity-50"
                  >
                    Cancel
                  </button>
                </div>
